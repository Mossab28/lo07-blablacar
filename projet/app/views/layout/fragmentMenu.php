<?php
/**
 * fragmentMenu : barre de menus dynamique selon le rôle de l'utilisateur.
 *
 * Affiche toujours : noms des étudiants, identité + solde du connecté,
 * et les menus Innovations / Examinateur / Se connecter.
 * Selon le rôle, affiche EN PLUS un seul des trois menus métier
 * (Administrateur, Conducteur ou Passager). Si personne n'est connecté,
 * aucun menu métier n'est affiché.
 */
...
/** Petit helper pour fabriquer un lien d'action. */
...
<nav class="menubar">
    ...
    <ul class="menubar-nav">
        <?php /* --- Menu métier selon le rôle (un seul affiché) --- */ ?>
